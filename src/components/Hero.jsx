    ...
    <div className="flex justify-between items-center">
      ...
      >
        <div className="flex w-[80%] mx-auto text-white  font-bold justify-around">
          <h1 className="border-white border-2 cursor-pointer hover:scale-105 transition-all duration-300  rounded-3xl p-2">
            Featured
          </h1>
          <h1 className="border-white border-2  cursor-pointer hover:scale-105 transition-all duration-300 rounded-3xl p-2">
            Reviews
        ...
        <div className="flex justify-around">
          <div className="bg-white gap-2 flex justify-between rounded-3xl p-4">
            ...
            <div className="flex flex-col gap-1 justify-between">
              <h1 className="text-xl font-bold text-[1B1C57]">1k + People</h1>
              <p className="text-sm text-[68799F]">Successfully Getting Home</p>
            </div>
          </div>
          <div className="bg-white gap-2 flex justify-between rounded-3xl p-4">
            <img src={house2} alt="" className="w-10 h-10 rounded-full" />
            <div className="flex flex-col  justify-between">
              <h1 className="text-xl font-bold text-[1B1C57]">56 houses</h1>
              <p className="text-sm text-[68799F]">Sold Monthly</p>
            </div>
          </div>
        </div>
      </div>
