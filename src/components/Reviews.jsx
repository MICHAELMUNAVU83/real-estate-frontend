      ...
      <div className="p-4  w-[80%] mx-auto ">
        ...
        >
          <SwiperSlide className="h-[70vh]">
            <div className=" w-[90%] mx-auto  text-gray-900">
              <div>
                <img
                  src={house1}
                  alt=" random imgee"
                ...
                <div className="relative mx-auto w-[80%] px-auto -mt-16  ">
                  <div className="bg-white   p-8 rounded-lg shadow-lg">
                    ...
                    <h4 className="mt-1 w-[50%] lexend-400 md:text-sm text-xs text-[##626687] ">
